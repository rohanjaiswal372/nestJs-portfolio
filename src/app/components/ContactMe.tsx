...
function ContactMe({}: Props) {
  ...
  const onSubmit: SubmitHandler<Inputs> = (formData) => {
    window.location.href = `mailTo:jlrohan56@gmail.com?subject=${formData.subject}$body=Hi, my name is ${formData.name}. ${formData.message} (${formData.email})`;
      ...
      <div className='flex flex-col space-y-10'>
        ...
        <div className='space-y-10'>
          ...
          <div className='flex items-center space-x-5 justify-center'>
            ...
            <p className='text-2xl'>jlrohan56@gmail.com</p>
          </div>

          <div className='flex items-center space-x-5 justify-center'>
            <MapPinIcon className='text-[#F7AB0A] h-7 w-7 animate-pulse'/>
            <p className='text-2xl'>+123 Denver Street</p>
          </div>          
        </div>
